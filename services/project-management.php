...
<div id="middle" class="wrapper">
    <div class="left_side">
        <div class="breadcrumb append_top_1 append_bottom_1">
            <div class="grid_20">
                ...
                <span class="active_2">Project Management</span>
            </div>
        ...
        <div class="box-side-menu">
            ...
            <ul class="side-menu">
                ...
                <li><a class="active" href="http://<?php echo $url ?>services/project-management.php">Project Management</a></li>
    ...
    <div class="right_side">
        <h1 class="content_title">Project Management</h1>
        <img class="img_content_wide" src="http://<?php echo $url ?>/images/content/project-management.jpg" alt="Project Management" />
        <ul>
