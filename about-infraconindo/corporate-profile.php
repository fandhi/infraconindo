...
<div id="middle" class="wrapper">
    <div class="left_side">
        ...
        <div class="box-side-menu">
            ...
            <ul class="side-menu">
                <li><a class="active" href="http://<?php echo $url ?>about-infraconindo/corporate-profile.php">Corporate Profile</a></li>
    ...
    <div class="right_side">
        ...
        <p class="indent">INFRACONINDO MEGATAMA  is a fast growing telecommunication contractor specializing in the provision of full services for the deployment of networks infrastructures and other telecommunication related project in global market.</p>

        <p class="indent">As a part of our continuous effort to service our partner across multiple location, we are continuing to expand our national presence. 
