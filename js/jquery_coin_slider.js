...
//			}).mouseover( function(){ $('#cs-navigation-' + el.id).show(); });
                        ...
                        //background gradien
                        $("<div id='bg-blue'><div id='frame-" + el.id + "' class=''><div id='bg-gradien'></div></div></div>").appendTo($('#coin-slider-' + el.id));
			// image buttons
			$("<div class='button-control'><div id='cs-buttons-" + el.id + "' class='cs-buttons'></div></div>").appendTo($('#coin-slider-' + el.id));
		...
		var init = function (el) {
			...
			// create title bar
			$('#' + el.id).append("<div class='cs-title' id='cs-title-" + el.id + "' style='position: absolute; top:150px; left: 215px; z-index: 100;'></div>");
	...
	$.fn.coinslider.defaults = {
		width: 1360, // width of slider panel
		height: 546, // height of slider panel
